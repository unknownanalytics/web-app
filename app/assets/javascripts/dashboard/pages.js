        ...
        methods: {
            ...
            drawPie(values, labels, type) {
                ...
                var data = {
                    datasets: [{
                        data: values,
                        backgroundColor: App.Helpers.PALETTE_COLORS,
                    }],
                    labels: labels
                };
                var canvas = document.getElementById("canvas_pages_" + type);
                ...
                new Chart(ctx, {
                    ...
                    options: {
                        ...
                        outerRadius: 80,//Here for outerRadius
                    }
                });
            },
            /**
            ...
            drawViewsLine(viewsByDay) {
                ...
                let data = [];
                range.forEach(day => {
                    data.push([day, viewsByDay[day] ? viewsByDay[day][0].count : 0]);
                });
                ...
                let pieces = App.Helpers.PALETTE_COLORS.map(color => {
                    return {
            ...
            drawViewDaily() {
                ...
                var myChart = echarts.init(document.getElementById('main_months_chart'));
